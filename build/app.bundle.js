...
exports.addInteractive = addInteractive;
...
var Zone = function () {
    ...
    _createClass(Zone, [{
        key: 'add',
        value: function add(key, component, type) {
...
function initInjector(zId) {
    return new Promise(function (resolve, reject) {
        window.addEventListener('zone.' + zId + '.connected', function (e) {
            return resolve(e);
        });
...
function add(zId, key, component) {
    ...
    return new Promise(function (resolve, reject) {
        var ev = new CustomEvent('zone.' + zId + '.add', {
            detail: { key: key, component: component, type: type }
        });
        window.dispatchEvent(ev);
    });
}

function confirmInteractive(zId, node) {
    var ev = new CustomEvent('zone.' + zId + '.confirmInteractive', {
        detail: { node: node }
    });
    window.dispatchEvent(ev);
}

function addInteractive(zId, key) {
    var type = TYPES.INTERACTIVE;
    return new Promise(function (resolve, reject) {

        window.addEventListener('zone.' + zId + '.confirmInteractive', function (e) {
            resolve(e.detail.node);
        });

        var get = new CustomEvent('zone.' + zId + '.add', { detail: { key: key, type: type } });
...
*/
var aa=__webpack_require__(2),m=__webpack_require__(12),A=__webpack_require__(3),B=__webpack_require__(1),ca=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),ha=__webpack_require__(16),ia=__webpack_require__(17),C=__webpack_require__(4);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h5',
                    null,
                    'I\'m a test component - I allow injection'
                ),
                _react2.default.createElement(_Zone2.default, { extId: '12', zone: 'test' })
            );
        }
    }]);
...
var _zones = __webpack_require__(11);
...
var InteractiveComponent = function (_React$Component) {
    _inherits(InteractiveComponent, _React$Component);

    function InteractiveComponent() {
        _classCallCheck(this, InteractiveComponent);

        return _possibleConstructorReturn(this, (InteractiveComponent.__proto__ || Object.getPrototypeOf(InteractiveComponent)).apply(this, arguments));
    }

    _createClass(InteractiveComponent, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            (0, _zones.confirmInteractive)(this.props.zone, this.node);
        }
    }, {
...
var Zone = function (_Component) {
    ...
    _createClass(Zone, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            (0, _zones.initHost)(this.props.zone, this);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return this.zone.children.reduce(function (acc, child) {
                switch (child.type) {
                    case _zones.TYPES.COMPONENT:
                        acc.push(_react2.default.createElement(child.c, _extends({ key: child.key }, _this4.props)));
                        break;
                    case _zones.TYPES.INTERACTIVE:
                        acc.push(_react2.default.createElement(InteractiveComponent, _extends({ key: child.key }, _this4.props)));
                        break;
                }
                return acc;
            }, []);
